...
<body>
  ...
  <div class="col-md-6">
    ...
    <div class="input-group has-validation">
      <input type="text" class="form-control" id="validationCustomUsername" aria-describedby="inputGroupPrepend" placeholder="26" name="Age" required>
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" id="validationCustom03" name="Country" placeholder="United Arab Emirates" required>
    <div class="invalid-feedback">
